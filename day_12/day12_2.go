...
func (pots *Pots) generation(rules *map[string]byte) {
	...
	for matchPot := pots.FirstPot; matchPot.PotType != 35; matchPot = matchPot.Next {
		pots.FirstPot = matchPot
		matchPot.Previous = nil
	}

	for matchPot := pots.LastPot; matchPot.PotType != 35; matchPot = matchPot.Previous {
		pots.LastPot = matchPot
		matchPot.Next = nil
	}
...
func main() {
	...
	fmt.Printf("Total Plants after 5000 generations: %d\n", plants)
	...
	fmt.Printf("Total Plants after 50000 generations: %d\n", plants)
